<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListPCADetail.aspx.cs" Inherits="ListPCADetail" %>
...
<LocalReport ReportPath="rptPCAListDetail.rdlc" EnableHyperlinks="True"><DataSources>
    <rsweb:ReportDataSource DataSourceId="SqlDSLiability" Name="DSPCALiability_DataTable1" />
    <rsweb:ReportDataSource DataSourceId="SqlDSPCAListDetail" Name="DSPCAListDetail_DataTable1" />
</DataSources>
</LocalReport>
</rsweb:ReportViewer>
        <asp:ObjectDataSource ID="ObjectDataSource5" runat="server" SelectMethod="GetData"
            TypeName="DSCPUListDetailTableAdapters.DataTable1TableAdapter"></asp:ObjectDataSource>
        <asp:ObjectDataSource ID="ObjectDataSource4" runat="server" SelectMethod="GetData"
            TypeName="DSPCAListDetailTableAdapters.DataTable1TableAdapter"></asp:ObjectDataSource>
        <asp:ObjectDataSource ID="ObjectDataSource3" runat="server" SelectMethod="GetData"
            TypeName="DSPCALiabilityTableAdapters.DataTable1TableAdapter"></asp:ObjectDataSource>
        <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="GetData"
            TypeName="DSListDetailTableAdapters.DataTable1TableAdapter"></asp:ObjectDataSource>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData"
            TypeName="DSPCADetailTableAdapters.DataTable1TableAdapter"></asp:ObjectDataSource>
