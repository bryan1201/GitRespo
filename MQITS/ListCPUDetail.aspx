<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListCPUDetail.aspx.cs" Inherits="ListCPUDetail" %>
<%@ Register assembly="Microsoft.ReportViewer.WebForms, Version=9.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a" namespace="Microsoft.Reporting.WebForms" tagprefix="rsweb" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>ListCPUDetail</title>
</head>
<body style="font-family:Arial Unicode MS;">
    <form id="form1" runat="server">
   <div style="font-family:Arial Unicode MS;">
        <rsweb:ReportViewer ID="rptDetail" runat="server" Font-Names="Arial Unicode MS" 
            Font-Size="9pt" Height="600px" Width="100%" SizeToReportContent="True">
            <LocalReport ReportPath="rptCPUListDetail.rdlc" EnableHyperlinks="True">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="SqlDSLiability" Name="DSPCALiability_DataTable1" />
                    <rsweb:ReportDataSource DataSourceId="SqlDSCPUListDetail" Name="DSCPUListDetail_DataTable1" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
