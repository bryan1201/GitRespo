<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NPIIssue.aspx.cs" Inherits="NPIIssue" MaintainScrollPositionOnPostback="true"%>
...
<body>
    ...
    <div style="text-align:center;width:100%">
        <div style="width:900px;text-align:center;" >
            ...
            <div class="bar_top">
                <h4><asp:label ID="lblIssueFunction" runat="server" Text="NPI Report/Edit Issue"></asp:label></h4>
            </div>
            <div style="width: 100%">
        ...
        <InsertItemTemplate>             
                ...
                <table style="border-right: #b6cade 2px solid; border-top: #b6cade 2px solid; border-left: #b6cade 2px solid; width: 899px; color: #333333; border-bottom: #b6cade 2px solid; font-family: 'Arial Unicode MS'; border-collapse: collapse; background-color: white" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <span id="spanUpdateSubmit" onclick="LockSubmit(document.all('fvComponent_UpdateSubmit').id);">
                            <asp:LinkButton ID="UpdateSubmit" runat="server" CommandArgument="Submit"
                                CommandName="Insert" Text="Submit Issue" Font-Bold="True" ForeColor="Red" Visible="False"></asp:LinkButton></span>
                            <asp:LinkButton ID="UpdateCancelButton" runat="server" CausesValidation="False" CommandName="Cancel"
                                Text="Cancel" Font-Bold="True" ForeColor="#C000C0" Visible="False" ></asp:LinkButton>
                            </td>
                        <td style="background-color: #b6cade; height: 18px;">
                        </td>
                        <td style="width:50%; height: 18px;">
                        </td>
                        <td style="height: 18px">
                        <asp:Label ID="lblIssueNoLabel" runat="server" Text="Issue No:" Visible="False"></asp:Label>
                        </td>
                        <td style="height: 18px">
                    ...
                    <table width="100%" style="font-family: 'Arial Unicode MS'; border-collapse: collapse; background-color: white; color: #333333;" cellpadding="1" cellspacing="1">
                        <tr>
                            <td style="width: 20%; color: #333333;  background-color: #b6cade;">
                                <span style="color: #ff0000">*</span><asp:Label ID="lblCustomer" runat="server">Customer</asp:Label></td>
                            ...
                            <td style="WIDTH: 30%; color: #333333; font-family: 'Arial Unicode MS';  background-color: #eff3f8;">
                                <asp:DropDownList ID="ddlCustomer" runat="server" Width="100%" DataSourceID="SqlDSCustomer" DataTextField="CustomerName" DataValueField="CustomerID" AutoPostBack="True"></asp:DropDownList></td>
                             <td style="width: 20%;  background-color: #b6cade;">
                                 <span><span><span><span style="color: #ff0000">*</span><asp:Label ID="lblSite" runat="server">Site</asp:Label></span></span></span></td>
                            <td style="width: 30%; color: #333333; background-color: #eff3f8;">
                                <asp:DropDownList ID="ddlSite" runat="server" Width="100%" DataSourceID="SqlDSSite" DataTextField="SiteName" DataValueField="SiteID" AutoPostBack="True">
                            </asp:DropDownList></td>
                        ...
                        <tr>
                            <td style="width: 20%; color: #333333;  background-color: #b6cade;">
                                <span style="color: #ff0000"></span><span style="color: #ff0000">*</span><asp:Label ID="lblProject" runat="server">Project</asp:Label></td>
                            <td style="WIDTH: 30%; color: #333333; font-family: 'Arial Unicode MS';  background-color: #eff3f8;">
                        ...
                        <tr>
                            <td style="width: 20%; color: #333333;  background-color: #b6cade; height: 22px;">
                                <span style="color: #ff0000">*</span><asp:Label ID="lblPhase" runat="server" Text="Project Phase"></asp:Label></td>
                            <td style="WIDTH: 30%; color: #333333; font-family: 'Arial Unicode MS';  background-color: #eff3f8; height: 22px;">
                                <asp:DropDownList ID="ddlPhase" runat="server" Width="100%"></asp:DropDownList></td>
                            ...
                            <td style="width: 20%;  background-color: #b6cade; height: 22px;">
                                <span>
                                <asp:Label ID="lblOwner" runat="server">Issue Owner</asp:Label></span></td>
                        ...
                        <tr>
                            ...
                            <td style="WIDTH: 30%; color: #333333; font-family: 'Arial Unicode MS';  background-color: #eff3f8;">
                                <asp:DropDownList ID="ddlPCACPU" runat="server" Width="100%" AutoPostBack="True" OnSelectedIndexChanged="ddlPCACPU_SelectedIndexChanged" DataSourceID="SqlDSPCACPU" DataTextField="TEXT" DataValueField="VALUE">
                                </asp:DropDownList></td>
                            ...
                            <td style="width: 20%;  background-color: #b6cade;">
                                <asp:Label ID="lblStatus" runat="server">Status</asp:Label><asp:SqlDataSource ID="SqlDSStatus" runat="server" ConnectionString="<%$ ConnectionStrings:MQITSConnectionString %>" SelectCommand="SELECT * FROM [v_IssueStatus]"></asp:SqlDataSource>
                            </td>
                            <td style="width: 30%; color: #333333;  background-color: #eff3f8;">
                                <asp:DropDownList ID="ddlStatus" runat="server" Width="100%" DataSourceID="SqlDSStatus" DataTextField="TEXT" DataValueField="VALUE"></asp:DropDownList></td>
                        </tr>
                        <tr>
                            <td style="width: 20%; color: #333333; background-color: #b6cade">
                                <span style="color: #ff0000">*</span><asp:Label ID="lblStation" runat="server">Station</asp:Label></td>
                            <td style="width: 30%; color: #333333; font-family: 'Arial Unicode MS'; 
                                background-color: #eff3f8">
                                <asp:DropDownList ID="ddlStation" runat="server" Width="100%" DataSourceID="SqlDSStation" DataTextField="StationName" DataValueField="StationID"></asp:DropDownList></td>
                            <asp:SqlDataSource ID="SqlDSStation" runat="server" ConnectionString="<%$ ConnectionStrings:MQITSConnectionString %>" SelectCommand="/*&#13;&#10;IF Type='CPU'&#13;&#10;BEGIN&#13;&#10;&#9;SELECT StationID AS VALUE ,StationName  as TEXT&#13;&#10;&#9;FROM v_Station&#13;&#10;&#9;WHERE CustomerID=Customer AND MType='CPU' AND IsInUse=1&#13;&#10;&#9;ORDER BY Rank&#13;&#10;END&#13;&#10;ELSE&#13;&#10;BEGIN&#13;&#10;&#9;SELECT StationID AS VALUE ,StationName  as TEXT&#13;&#10;&#9;FROM v_Station&#13;&#10;&#9;WHERE CustomerID=Customer AND MType='PCA' AND IsInUse=1&#13;&#10;&#9;ORDER BY Rank&#13;&#10;END&#13;&#10;*/&#13;&#10;&#13;&#10;SELECT * FROM fn_GetStationList(@CustomerID,@ProjectID,@Material)">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="ddlCustomer" Name="CustomerID" PropertyName="SelectedValue" />
                                    <asp:ControlParameter ControlID="ddlProject" Name="ProjectID" PropertyName="SelectedValue" />
                            ...
                            <td style="width: 20%;  background-color: #b6cade">
                                <span>
                                <asp:Label ID="lblPendingDay" runat="server">Pending Day</asp:Label></span></td>
                            <td style="width: 30%; color: #333333; background-color: #eff3f8">
                                <asp:Label ID="lblPendDay" runat="server" Width="100%" ForeColor="Red" Font-Bold="True" Font-Size="10pt" ></asp:Label></td>
                        </tr>
                        <tr>
                            <td style="width: 20%; color: #333333;  background-color: #b6cade">
                            ...
                            <td style="width: 30%; color: #333333; font-family: 'Arial Unicode MS'; 
                                background-color: #eff3f8">
                                <asp:Label ID="lblFailQty" runat="server" Width="100%" ForeColor="Red" Font-Bold="True" Font-Size="10pt" ></asp:Label></td>
                            <td style="width: 20%; background-color: #b6cade">
                                <span><span style="color: #ff0000">*</span><asp:Label ID="lblPriority" runat="server">Priority</asp:Label><asp:SqlDataSource ID="SqlDSPriority" runat="server" ConnectionString="<%$ ConnectionStrings:MQITSConnectionString %>" SelectCommand="SELECT * FROM v_IssuePriority"></asp:SqlDataSource>
                                </span></td>
                            <td style="width: 30%; color: #333333;  background-color: #eff3f8">
                        ...
                        <tr>
                            <td style="width: 20%; color: #333333; background-color: #b6cade">
                                <span style="color: #ff0000"></span><span style="color: #ff0000">*</span><asp:Label ID="lblLiability" runat="server">Liability</asp:Label>
                                <asp:SqlDataSource ID="SqlDSLiability" runat="server" ConnectionString="<%$ ConnectionStrings:MQITSConnectionString %>" SelectCommand="SELECT * FROM v_IssueLiability"></asp:SqlDataSource>
                            </td>
                            <td style="width: 30%; color: #333333; font-family: 'Arial Unicode MS'; background-color: #eff3f8"><asp:DropDownList ID="ddlLiability" runat="server" Width="100%" DataSourceID="SqlDSLiability" DataTextField="TEXT" DataValueField="VALUE">
                            </asp:DropDownList></td>
                            <td style="width: 20%; background-color: #b6cade">
                                <asp:Label ID="lblFailureRate" runat="server" >Failure Rate</asp:Label></td>
                            <td style="width: 30%; color: #333333; background-color: #eff3f8">
                                <asp:Label ID="lblFailRate" runat="server" Width="100%" ForeColor="Red" Font-Bold="True" Font-Size="10pt"></asp:Label></td>
                        </tr>
                        <tr>
                            <td style="width: 20%; color: #333333; background-color: #b6cade">
                            ...
                            <td style="width: 30%; color: #333333; background-color: #eff3f8">
                                ...
                                <img id="Img2" alt="選取日期" runat="server" onclick="SPM_OpenCalendar(document.all('fvIssue$txtDueDate').name, false)" src="images/calendar.gif"/>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 20%; color: #333333; background-color: #b6cade;">
                        ...
                        <tr>
                            <td style="width: 20%; color: #333333;  background-color: #b6cade;">
                                ...
                                (PCA or CPU S/N)</td>
                            <td colspan="4" style="color: #333333; font-family: 'Arial Unicode MS';
                        ...
                        <tr>
                            <td style="width: 20%; color: #333333; background-color: #b6cade">
                                <span><span style="color: #ff0000">*</span><asp:Label ID="lblLocation" runat="server">Location</asp:Label>(For
                                    PCA Only)</span></td>
                            <td style="width: 30%; color: #333333; font-family: 'Arial Unicode MS'; background-color: #eff3f8">
                                <asp:TextBox ID="txtLocation" runat="server" Width="100%" TextMode="MultiLine"></asp:TextBox></td>
                            <td style="width: 20%; background-color: #b6cade">
                                <span style="color: #ff0000"></span><asp:Label ID="lblPackageType" runat="server">Package Type</asp:Label><br />
                                (For PCA Only)</td>
                            <td style="width: 30%; color: #333333; background-color: #eff3f8">
                                <asp:TextBox ID="txtPackageType" runat="server" Width="100%" TextMode="MultiLine"></asp:TextBox></td>
                        </tr>
                         <tr>
                        ...
                        <tr>
                            <td style="width: 20%; color: #333333; background-color: #b6cade; border-right: white 1px solid; border-top: white 1px solid; border-left: white 1px solid; border-bottom: white 1px solid; height: 27px;">
                                ...
                                (For CPU Only)</td>
                            <td style="width: 30%; color: #333333; font-family: 'Arial Unicode MS'; 
                                background-color: #eff3f8; height: 27px;">
                            ...
                            <td style="width: 20%;  background-color: #b6cade; height: 27px;">
                                <span style="color: #ff0000"></span><span style="color: #ff0000">*</span><asp:Label ID="Label4" runat="server">Faulty Commodity S/N</asp:Label><br />
        ...
        <ItemTemplate>
                ...
                <table style="border-right: #b6cade 2px solid; border-top: #b6cade 2px solid; border-left: #b6cade 2px solid; width: 899px; color: #333333; border-bottom: #b6cade 2px solid; font-family: 'Arial Unicode MS'; border-collapse: collapse; background-color: white" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td style="height: 18px">
                        <asp:Label ID="lblIssueNoName" runat="server" Text="Issue No:"></asp:Label>
                        </td>
                        <td style="height: 18px">
                        <asp:Label ID="lblIssueNo" runat="server" Text='<%# Eval("IssueSN", "{0}") %>'></asp:Label>
                        </td>
                        </tr>
                </table>
                <div style="width:99%; border-right: firebrick 2px solid; border-top: firebrick 2px solid; border-left: firebrick 2px solid; border-bottom: firebrick 2px solid; text-align: left;">
                    <table width="100%" style="font-family: 'Arial Unicode MS'; border-collapse: collapse; background-color: white; color: #333333;" cellpadding="1" cellspacing="1">
                        ...
                        <tr>
                            ...
                            <td style="width: 20%;  background-color: #b6cade">
                                ...
                                <asp:Label ID="lblPendingDay" runat="server">Pending Day</asp:Label></span></td>
                            <td style="width: 30%; color: #333333; background-color: #eff3f8">
                                <asp:Label ID="lblPendingName" runat="server" Text='<%# Bind("PendingDate", "{0}") %>'></asp:Label></td>
                        </tr>
                        <tr>
                            <td style="width: 20%; color: #333333;  background-color: #b6cade">
                               <asp:Label ID="lblFailedQty" runat="server">Failed Qty</asp:Label></td>
                            <td style="width: 30%; color: #333333; font-family: 'Arial Unicode MS'; 
                                background-color: #eff3f8">
                                <asp:Label ID="lblFailQtyName" runat="server" Text='<%# Bind("FailureQty", "{0}") %>'></asp:Label></td>
                            <td style="width: 20%; background-color: #b6cade">
                        ...
                        <tr>
                            ...
                            <td style="width: 20%; background-color: #b6cade">
                                <asp:Label ID="lblFailureRate" runat="server" >Failure Rate</asp:Label></td>
                            <td style="width: 30%; color: #333333; background-color: #eff3f8">
                                <asp:Label ID="lblFailureRateName" runat="server" Text='<%# Bind("FailureRate", "{0}") %>'></asp:Label></td>
                        </tr>
                        <tr>
                            <td style="width: 20%; color: #333333; background-color: #b6cade">
                                <span style="color: #ff0000"></span><asp:Label ID="lblIssueDate" runat="server">Issue Date</asp:Label></td>
                        ...
                        <tr>
                            ...
                            <td style="width: 30%; color: #333333; background-color: #eff3f8; border-bottom: white 2px solid;">
                                <asp:Label ID="lblPackageTypeName" runat="server" Text='<%# Bind("PackageType", "{0}") %>'></asp:Label></td>
                        </tr>
                        <tr>
                        ...
                        <table style="border-right: white 1px solid; border-top: white 1px solid; border-left: white 1px solid; width: 100%; color: #333333; border-bottom: white 1px solid; font-family: 'Arial Unicode MS'; border-collapse: collapse; background-color: white" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="width: 20%; background-color: #b6cade; border-bottom: white 1px solid; border-top-style: dotted;">
                                <span style="color: #ff0000"></span><asp:Label ID="lblCommdity" runat="server">Faulty Commodity</asp:Label><br />
                                (For CPU Only)</td>
                            <td style="width: 30%; 
                                background-color: #eff3f8; border-bottom: white 2px solid;">
                            ...
                            <td style="width: 20%;  background-color: #b6cade; border-bottom: white 2px solid;">
                                ...
                                <span style="color: #ff0000"></span>(For CPU Only)</td>
                            <td style="width: 30%;  background-color: #eff3f8; border-bottom: white 2px solid;">
    ...
    <div style="width:100%; text-align:left;">
         ...
         <asp:MultiView ID="mvIssueForm" runat="server">
            ...
            <table width="100%" style="font-family: 'Arial Unicode MS'; border-collapse: collapse; background-color: white; color: #333333; font-size: 10pt; border-top-style: groove; border-right-style: groove; border-left-style: groove; border-bottom-style: groove;" cellpadding="1" cellspacing="1" id="TABLE1">
                <tr>
                    <td style="width: 20%; color: #333333; background-color: #b6cade;" align="left">
                        <span style="color: #ff0000">*</span><asp:Label ID="lblAssignedTo" runat="server">AssignedTo</asp:Label></td>
                    <td style="WIDTH: 30%; color: #333333; font-family: 'Arial Unicode MS'; background-color: #eff3f8;" align="left">
                        <asp:DropDownList ID="ddlAssignedTo" runat="server" Width="100%"></asp:DropDownList>
                        <asp:SqlDataSource ID="SqlDSIssueMember" runat="server" ConnectionString="<%$ ConnectionStrings:MQITSConnectionString %>" SelectCommand="SELECT * FROM fn_GetIssueProjectOwner(@Project,2)">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="lblProjectID" Name="Project" PropertyName="Text" />
                        </SelectParameters>
                    ...
                    <td style="width: 30%; color: #333333;background-color: #eff3f8;">
                        ...
                        </asp:DropDownList><asp:SqlDataSource ID="SqlDSARStatus" runat="server" ConnectionString="<%$ ConnectionStrings:MQITSConnectionString %>" SelectCommand="SELECT * FROM v_IssueStatus WHERE VALUE NOT IN ('2','4')"></asp:SqlDataSource>
                        </td>
                ...
                <tr>
                    ...
                    <td style="width: 30%; color: #333333; background-color: #eff3f8;">
                        <asp:Label ID="txtPendingDay" runat="server" Width="100%" ></asp:Label></td>
                </tr>
                <tr>
                    <td align="left" style="width: 20%; color: #333333;  background-color: #b6cade">
                        <asp:Label ID="lblFinishDate" runat="server" Visible="False">Finish Date</asp:Label></td>
                    <td align="left" style="width: 30%; color: #333333; font-family: 'Arial Unicode MS';
                         background-color: #eff3f8">
                        <asp:TextBox ID="txtFinishDate" runat="server" Width="90%" Visible="False"></asp:TextBox>
                        <img id="Img4" alt="選取日期" runat="server" onclick="SPM_OpenCalendar(document.all('txtFinishDate').name, false)" src="images/calendar.gif" visible="false"/></td>
                    <td align="left" style="width: 20%; background-color: #b6cade">
                    </td>
                    <td style="width: 258px; color: #333333;background-color: #eff3f8">
                    </td>
                </tr>
                <tr>
                    <td style="width: 20%; color: #333333;background-color: #b6cade">
                    ...
                    <td align="left" colspan="3" style="color: #333333; font-family: 'Arial Unicode MS';
                        background-color: #eff3f8; width: 80%;">
                        <asp:TextBox ID="txtActionDescription" runat="server" Width="99%" 
                ...
                <tr>
                    ...
                    <td align="left" colspan="3" style="color: #333333; font-family: 'Arial Unicode MS';
                        ...
                        <asp:TextBox ID="txtCompletionComment" runat="server" Width="99%" TextMode="MultiLine"></asp:TextBox></td>
                </tr>
                 <tr>
                     <td colspan="4" style="text-align:center; width:80%; height: 24px;">
                        <table style="width:90%; font-family:Arial Unicode MS;">
                            <tr>
                                ...
                                <td>&nbsp;</td>
                                <td><asp:HyperLink ID="hlSQMP" runat="server" Text="Link to SQIP" Target="_blank" 
                ...
                <tr>
                    <td  colspan="4" align="center">
                       <asp:GridView ID="gvAR" runat="server" CellPadding="2" ForeColor="#333333" Width="100%" AutoGenerateColumns="False" DataSourceID="SqlDSAR" DataKeyNames="ActionID" OnSelectedIndexChanged="gvAR_SelectedIndexChanged">
                        ...
                        </asp:SqlDataSource><asp:Button ID="btnSendMail" runat="server"  
                            Text="SendMail" OnClick="btnSendMail_Click" Font-Bold="True" 
                            Font-Names="Century Gothic"  /></td>
            </tr>
            </table>
            </asp:View>
                      ...
                      <tr>
                            ...
                            <td style="color: #333333; font-family: 'Arial Unicode MS'; background-color: #eff3f8;" 
                                ...
                                <asp:Button ID="btnUpload" Text="Upload" runat="server" 
                                    OnClick="btnUpload_Click" Font-Bold="True" Font-Names="Century Gothic" /></td>
                       </tr>
                  </table>
                 ...
                 <table width="100%" style="font-family: 'Arial Unicode MS'; border-collapse: collapse; background-color: white; color: #333333; font-size: 10pt; border-top-style: groove; border-right-style: groove; border-left-style: groove; border-bottom-style: groove;" cellpadding="1" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td style="color: #333333; font-family: 'Arial Unicode MS';  background-color: #eff3f8; height: 23px;" 
                            ...
                            <asp:Button ID="btnUploadPhoto" Text="Upload" runat="server" 
                                OnClick="btnUploadPhoto_Click" Font-Bold="True" Font-Names="Century Gothic" 
                                Width="60px" /></td>
                    </tr>
                    </table>
            ...
            <asp:View ID="vHH" runat="server">
              <table width="100%" style="font-family: 'Arial Unicode MS'; border-collapse: collapse; background-color: white; color: #333333; font-size: 10pt;" cellpadding="1" cellspacing="1">
                      ...
                      <td colspan="4" style="text-align:center;">
                          <table width="100%" style="font-family: 'Arial Unicode MS'; border-collapse: collapse; background-color: white; color: #333333; border-top-style: groove; border-right-style: groove; border-left-style: groove; border-bottom-style: groove;" cellpadding="1" cellspacing="1">
                              <tr>
                                  ...
                                  <td style="width: 16%;  background-color: #b6cade;" align="left">
                                      <span style="color: #ff0000">*</span><asp:Label ID="lblFailQty" runat="server">Failure Qty</asp:Label></td>
                                  <td style="width: 17%">
                            ...
                            <asp:Button ID="btnAddHH" runat="server" Text="Save" OnClick="btnAddHH_Click" 
                                          Font-Bold="True" Font-Names="Century Gothic" Width="60px" />
                                      &nbsp;
                                      <asp:Button ID="btnCancelHH" runat="server" OnClick="btnCancelHH_Click" 
                                          Text="Cancel" Font-Bold="True" Font-Names="Century Gothic" Width="60px" /></td>
                              </tr>
                          </table>
                       </td>
                  </tr>
                ...
                <asp:SqlDataSource ID="SqlDSHH" runat="server" ConnectionString="<%$ ConnectionStrings:MQITSConnectionString %>" SelectCommand="SELECT HandingID,IssueID,CONVERT(NVARCHAR(10),HandingDate,111) as HandingDate,&#13;&#10;InputQty,FailureQty,HandingNote,editor,&#13;&#10;CASE WHEN editor =@editor THEN 'True'&#13;&#10;&#9; WHEN @lblreporter =@editor THEN 'True'&#13;&#10;&#9; WHEN @ProjectOwner='Y' THEN 'True'&#13;&#10;ELSE 'False' END as EditVisible&#13;&#10;FROM f_HandingHistory&#13;&#10;WHERE IssueID=@IssueID&#13;&#10;ORDER BY HandingDate">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="txtUserId" Name="editor" PropertyName="Text" />
                        <asp:ControlParameter ControlID="lblReporterBadgeCode" Name="lblreporter" PropertyName="Text" />
                        <asp:ControlParameter ControlID="lblIssueOwnerBadgeCode" Name="ProjectOwner" PropertyName="Text" />
            ...
            <asp:View ID="vrdc" runat="server">
                ...
                <asp:Button ID="btnRepeatDefect" runat="server" Text="Repeat Defect Check" 
                        CausesValidation="False" onclick="btnRepeatDefect_Click" Width="145px" 
                    Font-Bold="True" Font-Names="Century Gothic" />
                    <br />
                <asp:Button id="btnConfirm" runat="server" Text="Confirm" Visible="False"></asp:Button><br />
                    <asp:GridView ID="gvRepeatDefectCheck" runat="server" 
                    AutoGenerateColumns="False" CellPadding="2"
                        ForeColor="#333333" GridLines="Vertical" Width="100%"  
                    OnRowDeleting="gvRepeatDefectCheck_RowDeleting">
                ...
                <tr>
                    <td style="width: 10%; background-color: #b6cade">
                     ...
                     <td style="width: 10%; text-align: center">
                         <asp:Button ID="btnAddNote" runat="server" Text="Save" 
                             OnClick="btnAddNote_Click" Font-Bold="True" Font-Names="Century Gothic" 
                             Width="60px" /></td>
                </tr>
                </table>
        ...
        <asp:SqlDataSource ID="SqlDSNPIIssue" runat="server" ConnectionString="<%$ ConnectionStrings:MQITSConnectionString %>" SelectCommand="sp_NPIIssue" SelectCommandType="StoredProcedure">
        <SelectParameters>
        ...
        <asp:SqlDataSource ID="SqlDSNPIDetailIssues" runat="server" ConnectionString="<%$ ConnectionStrings:MQITSConnectionString %>" SelectCommand="SELECT * FROM [v_NPIIssue_ItemMode] WHERE IssueID=@IssueID">
        <SelectParameters>
        <asp:ControlParameter ControlID="lblIssueID" Name="IssueID" PropertyName="Text" />
        </SelectParameters>
        </asp:SqlDataSource>
        ...
        <asp:Label ID="lblObjectName" runat="server" Text="LISTISSUE" Visible="False"></asp:Label><asp:TextBox ID="txtUserId" runat="server" Visible="False"></asp:TextBox>
