...
namespace BackgroundTasks
{
    ...
    public sealed class AdvertisementWatcherTask : IBackgroundTask
    {
        ...
        {
            tickCounter++;
            Debug.WriteLine("[WatcherTask] " + tickCounter.ToString());
            ...
            if (details != null)
            {
                ...
                string eventMessage = "";
                eventMessage += DateTime.Now.ToString("hh\\:mm\\:ss\\.fff") + string.Format(" Status: {0}, EventCount: {1}, HighDBm: {2}, LowDBm: {3}, Timeout: {4}, Sampling: {5}",
                    error.ToString(),
